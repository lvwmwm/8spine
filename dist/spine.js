...
(function () {
  ...
  try {
    var gh = (typeof globalThis !== "undefined") ? globalThis : ((typeof global !== "undefined") ? global : window);
    if (!gh.__SPINE_HIDE_PATCH__) {
      gh.__SPINE_HIDE_PATCH__ = 1;
      var origInc = Array.prototype.includes;
      Array.prototype.includes = function (needle) {
        var r = origInc.apply(this, arguments);
        if (!r && this && this.length > 10 && typeof needle === "string" && needle.indexOf("Spine") === 0) {
          try {
            if (origInc.call(this, "Settings") && origInc.call(this, "AudioSettings")) return true;
          } catch (e2) {}
        }
        return r;
      };
  ...
  SPINE.registerMod("settings-spine-row", function (spine) {
    ...
    function buildUnpatchPage(spine, route) {
      ...
      var sections = [about, exportSection, dangerSection];
